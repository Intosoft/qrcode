...
(() => {
  ...
  var getPositionForEyes = ({ matrixLength, cellSize, addition = 0 }) => {
    return {
      eyeball: {
        topLeft: {
          x: 3.5 * cellSize,
  ...
  var circleEyeball = ({ matrixLength, size }) => {
    let path = "";
...
`;
  ...
  var squareEyeball = ({ matrixLength, size }) => {
    const cellSize = size / matrixLength;
  ...
  // src/eyeframes.ts
  var circleEyeFramePath = ({ x, y, length, cellSize }) => {
  ...
  var circleEyeFrame = ({ matrixLength, size }) => {
    let path = "";
    const cellSize = size / matrixLength;
  ...
  var squareEyeFramePath = ({ cellSize, length, x, y }) => {
    return `M${x + cellSize / 2},${y + cellSize / 2}H${
      x + length - cellSize / 2
    }V${y + length - cellSize / 2}H${x + cellSize / 2}Z`;
  };
  var squareEyeFrame = ({ matrixLength, size }) => {
    const cellSize = size / matrixLength;
  ...
  var roundedEyeFramePath = ({ cellSize, length, x, y }) => {
  ...
  var roundedEyeFrame = ({ matrixLength, size }) => {
    const cellSize = size / matrixLength;
    const length = cellSize * 7;
    const positions = getPositionForEyes({ matrixLength, cellSize });
    let path = "";
  ...
  // src/path/circle.ts
  var generateCirclePath = ({ i, j, cellSize }) => {
    let path = "";
    const x = cellSize * j;
    const y = cellSize * i;
  ...
  // src/path/square.ts
  var generateSquarePath = ({ i, j, cellSize }) => {
    let path = "";
    const x = cellSize * j;
    const y = cellSize * i;
    path += `M${x},${y} `;
